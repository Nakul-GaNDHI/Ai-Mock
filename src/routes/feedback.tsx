...
// Type for answers coming from QuestionSection
type NavAnswer = {
  question: string;
  answer: string;
};
...
export const Feedback = () => {
  ...
  const navAnswers = useMemo<NavAnswer[]>(() => {
  ...
  useEffect(() => {
    ...
    // CASE 1: Answers came from QuestionSection (latest attempt)
    if (navAnswers.length > 0) {
      const tempFeedbacks: UserAnswer[] = navAnswers.map(
        (ans: NavAnswer, index: number) => ({
          id: index.toString(),
          question: ans.question,
          user_ans: ans.answer,
          correct_ans: "Expected answer will be generated by AI.",
          feedback: "Detailed AI feedback will appear here.",
          rating: Math.floor(Math.random() * 3) + 7, // temp rating 7–9
          userId: userId || "",
          mockIdRef: interviewId,
          createdAt: Timestamp.now(), // ✅ Firebase Timestamp
          updateAt: Timestamp.now(),  // ✅ Firebase Timestamp
        })
      );
    ...
    // CASE 2: Fetch from Firebase (old interviews)
          ...
          {feedbacks.map((feed) => (
            ...
            >
              ...
              <AccordionContent className="px-5 py-6 bg-white rounded-b-lg space-y-5 shadow-inner">
                ...
                <Card className="border-none p-4 bg-green-50 rounded-lg shadow-md">
                ...
                <Card className="border-none p-4 bg-yellow-50 rounded-lg shadow-md">
                  <CardTitle className="flex items-center text-lg">
                ...
                <Card className="border-none p-4 bg-red-50 rounded-lg shadow-md">
                  <CardTitle className="flex items-center text-lg">
